...
class WinDisplay():
    ...
    def loads(self):
        ...
        self.continue_button = pygame.image.load("resources/images/B_continue.png").convert()
    ...
    def create_rect(self):
        ...
        self.continue_rect = pygame.Rect((170, 400), (180, 25))
    ...
    def display(self):
        ...
        while loop == 1:
            ...
            self.window_surface.blit(self.continue_button, [170, 400])
